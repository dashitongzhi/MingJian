...
def _build_fast_round_plan(
    ...
    fast_plan = [
        (
            1,
            "advocate",
            "【第1轮·立论】战略支持者：请提出支持该命题的核心证据链。要求：至少2条独立论证，每条引用具体数据源。",
        ),
        (
            1,
            expert,
            f"【第1轮·立论】{expert_label}：请从专业角度评估命题并提供分析。要求：引用具体数据和来源，提供专业判断。",
        ),
        (
            2,
            "challenger",
            "【第2轮·质询+仲裁】风险挑战者：请对立论进行系统性质疑，然后综合评判。要求：对每条论点给出质疑理由，最终给出综合裁决和建议。",
        ),
    ]
